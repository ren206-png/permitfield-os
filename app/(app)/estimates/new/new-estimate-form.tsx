...
import { createEstimateAction, type NewEstimateState } from './actions';
...
const initialState: NewEstimateState = {};
...
export function NewEstimateForm({ clients, projects }: { clients: Client[]; projects: Project[] }) {
  ...
  return (
    <form action={formAction} className="flex flex-col gap-5">
      ...
      <div>
        ...
        <textarea id="exclusions" name="exclusions" rows={2} className={inputClass} />
      </div>
      <div>
      ...
      >
        {pending ? 'Creating…' : 'Create draft estimate'}
      </button>
    </form>
  );
}
