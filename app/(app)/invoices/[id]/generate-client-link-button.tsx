...
import { generateInvoiceClientLinkAction, type GenerateInvoiceClientLinkState } from './actions';

const initialState: GenerateInvoiceClientLinkState = {};

// Gate 4 (Quotes & Payments), Phase A. Mirrors
// app/(app)/estimates/[id]/generate-client-link-button.tsx exactly -- see
// that file's own comment.
export function GenerateInvoiceClientLinkButton({ invoiceId }: { invoiceId: string }) {
  const [state, formAction, pending] = useActionState(generateInvoiceClientLinkAction, initialState);
