...
// Registers permit.extract, permit.audit, permit.generate_pdf, the Gate 4
// (Quotes & Payments) quotes-payments-reminders cron, (Gate 5, sub-phase
// 5.2) permit.drawing_review, and (Gate 5, sub-phase 5.3) permit.notify with
// Inngest's dev server / cloud. Gate 5, sub-phase 5.3 hardening:
